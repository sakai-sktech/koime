...
<img src="docs/assets/koime-UI.jpg" alt="KoIME キーボード UI — 中央にマイク、左右にカーソルキー、右上に UNDO" width="480">
...
- **自分のカスタムアプリが数分で組める時代に、主権を手放す理由がない**。
  ...
  もうない。データも主権も自分で握っておけ — KoIME はそのための、動くベースである。
...
| [docs/DESIGN-DECISIONS.md](docs/DESIGN-DECISIONS.md) | 設計判断ログ DD-001〜016 — なぜこう作ったかは全部ここにある |
